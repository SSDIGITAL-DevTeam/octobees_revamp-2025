...
import { CirclePlus, Pencil, Search, Star, Trash } from "lucide-react";
...
import { TableBlog } from "@/components/partials/table";
  ...
  return (
    <main className="w-full flex flex-col gap-12 pb-12">
      ...
      <section className="flex flex-col gap-16 p-8 rounded-3xl bg-white border border-border shadow-sm w-full min-h-[50vh] items-center">
        ...
        <TableBlog blogs={blogs?.data || []} setSort={setSort} sort={sort} setRefetch={setRefetch} refetch={refetch} />
