...
--> statement-breakpoint
ALTER TABLE `affiliate_application` MODIFY COLUMN `status` enum('pending','qualified','approved','rejected') NOT NULL DEFAULT 'pending';
--> statement-breakpoint
ALTER TABLE `assessment_question` MODIFY COLUMN `options` text;
--> statement-breakpoint
ALTER TABLE `assessment_session` MODIFY COLUMN `session_status` varchar(20) NOT NULL DEFAULT 'not_started';
--> statement-breakpoint
