...
INSERT INTO `partner_performance_setting` (
  `id`, `basic_salary_amount`, `basic_salary_sales_threshold`,
  `first_month_minimum_closed_clients`, `initial_commission_full_client_threshold`,
  `termination_grace_days`, `is_active`
) SELECT
  'default-partner-performance-setting', 3500, 35000, 1, 2, 2, true
WHERE NOT EXISTS (
