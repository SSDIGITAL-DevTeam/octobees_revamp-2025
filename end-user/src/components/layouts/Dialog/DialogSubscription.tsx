        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="z-[103] lg:h-[480px] bg-white rounded-2xl sm:rounded-3xl flex flex-col lg:flex-row items-center w-full sm:max-w-full sm:w-[62vw] p-0 sm:p-0 overflow-hidden">
                ...
                <DialogHeader className="px-8 space-y-3 lg:space-y-5 max-w-[90%] mx-auto lg:max-w-full pt-3 md:pt-0 pb-10">
                    ...
                    <DialogDescription className="hidden">Dialog Subscription</DialogDescription>
                    <div className="space-y-8 lg:space-y-10 flex flex-col items-center lg:items-start">
                        ...
                        <FormSubscription setOpen={setOpen} source="homepage-dialog" className="p-3 border-[1px] shadow-sm border-gray-300" />
                    </div>
                </DialogHeader>
            </DialogContent>
        </Dialog>
