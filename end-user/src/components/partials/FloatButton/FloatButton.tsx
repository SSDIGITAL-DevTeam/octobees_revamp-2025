  ...
  return (
    <>
      {isVisible && !isFooterVisible && (
        <div className={`fixed bottom-3 right-3 lg:bottom-7 lg:right-7 z-[51] flex justify-center items-center p-4 transition-transform duration-300 transform ${isVisible ? 'translate-y-0 animate-slide-up' : 'translate-y-full animate-slide-down'} z-50`}>
