  ...
  return (
    <>
      ...
      <main className="bg-light font-openSans overflow-x-hidden">
        {/* Header or Hero */}
        <header className="flex flex-col overflow-x-hidden py-[50px] lg:py-[100px] bg-merah-200/30 min-h-[75vh] lg:min-h-[90vh] items-center justify-center">
          ...
          <div className="container flex flex-col justify-center items-center lg:flex-row px-10 lg:px-[9rem] 2xl:px-5 lg:gap-x-14 xl:gap-x-14">
            <div className="flex flex-col gap-y-14 lg:max-w-[45%]">
              <div className="flex flex-col gap-y-5">
                <h1 className="w-full text-3xl lg:text-4xl text-primary font-bold font-heading  !leading-[120%]">Improving our services and quality continuously</h1>
              ...
              <div className="flex flex-col gap-y-4">
                <h1 className="w-full text-3xl lg:text-4xl font-bold text-primary font-heading  !leading-[120%]">Doing best practice in every project</h1>
        ...
        {/* Section 4 */}
             ...
             <div className="flex flex-col md:gap-3 gap-2 items-center justify-center">
               <h1 className=" text-4xl md:text-5xl font-bold text-merah-200">20+</h1>
               <p>Client worldwide</p>
             </div>
             <div className="flex flex-col md:gap-5 gap-2 items-center justify-center">
               <h1 className=" text-4xl md:text-5xl font-bold text-merah-200">40+</h1>
               <p>Companies we’ve helped to upscale</p>
             </div>
             <div className="flex flex-col md:gap-5 gap-2 items-center justify-center">
               <h1 className=" text-4xl md:text-5xl font-bold text-merah-200">2 years</h1>
               <p>of Operations</p>
             </div>
           </section>
        ...
        <section className="flex flex-col py-[60px] lg:py-[150px] items-center justify-center">
          <div className="container flex flex-col px-5 lg:px-[5rem] 2xl:px-[3rem] gap-y-[3rem] lg:gap-y-[5rem] xl:gap-y-[7rem] h-full">
            <div className="flex flex-col px-5">
              <ClientBrand />
              <h1 className="text-center mt-7 font-semibold text-lg text-primary">And many more</h1>
            </div>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center gap-y-7 lg:gap-y-0 lg:gap-x-16 2xl:gap-x-32">
                ...
                <div className=" p-8 lg:p-10 lg:w-[58%] rounded-2xl">
                  <div className="flex flex-col gap-y-6">
                    <h1 className="font-heading text-3xl text-primary font-semibold !leading-[120%]">Hi, I’m Harvine, the CEO of Octobees</h1>
                    ...
                    <p className='text-black'>- Harvine Khong, Co-Founder & CEO</p>
                  </div>
                </div>
              </div>
            </div>
