...
const TestimonialsDiagram = () => (
    <svg className="lg:w-2/3 w-full lg:px-0 px-10" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="space-y-10 md:space-y-20 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-rows-4 gap-8">
                <div className="md:col-span-4 lg:row-span-2 h-[40vh] md:h-[45vh] w-full relative group overflow-hidden rounded-[30px] shadow-md">
                    <Image
                ...
                <div className="md:col-span-2 md:row-span-2 md:col-start-5 h-[40vh] md:h-[45vh] bg-primary rounded-[30px] p-10 shadow-md">
                ...
                <div className="md:col-span-6 md:row-span-2 md:row-start-3 h-[40vh] md:h-[45vh] flex flex-col justify-center bg-[#FFEEEF] p-10 lg:p-14 rounded-[30px] shadow-md">
